package com.cracky_axe.pxohlqo.keepfit.ui.addFood
...
import com.cracky_axe.pxohlqo.keepfit.util.NewPicassoEngine
...
const val REQUEST_CODE_CHOSEN_IMAGE = 2020
...
class AddFoodActivity : AppCompatActivity(), AnkoLogger {
    ...
    fun addFoodItem(view: View) {
        val food = FoodEntity(
                ...
                unit = add_food_foodUnti_editText.text.toString(),
                imageUri = imageUri,
